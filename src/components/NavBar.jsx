...
import { faCartShopping, faCar, faBasketShopping } from "@fortawesome/free-solid-svg-icons";
        ...
        <header>
            <div className={styles['headertotal']}>
                ...
                <div className={styles['headercentro']}>
                    ...
                    <input type="text" autoComplete='off' value={textoBusqueda} onChange={(ev) => { setTextoBusqueda(ev.target.value) }} placeholder="Nombre Cliente" />
                    <button onClick={() => { getAllCarulla(textoBusqueda) }}>Busquedas multiple </button>
                </div>
